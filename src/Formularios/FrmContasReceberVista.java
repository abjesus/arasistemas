 ...
 * @author Abel
 */
public class FrmContasReceberVista extends javax.swing.JFrame {
    
    DecimalFormat formater = new DecimalFormat("##,##0.00"); 
    int idCliente, idVenda, nparc;
    double desconto, juros;

    /** Creates new form FrmVendaVista */
    public FrmContasReceberVista() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setBounds((screenSize.width-451)/2, (screenSize.height-355)/2, 451, 355);
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
      ...
      try { 
        ...
        if(din > total){
            ...
            cr.setVlr_juros(juros);
            cr.setVlr_desc(desconto);
            cr.setTipo_pgto("Dinheiro");
            cr.setId_venda(idVenda);
            cr.setNparc(nparc);
            cr.setVlr_final(total);
            cr.setId_cliente(idCliente);
    ...
    public Double retornaTotal(Double valor, int cliente, int venda, int parcela, double desc, double jur){
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new FrmContasReceberVista().setVisible(true);
            }
        });
    }
